 ...
 *     nwr/historic nwr/tourism=viewpoint,attraction,museum,artwork,gallery nwr/amenity=cafe,place_of_worship nwr/natural=beach nwr/leisure=garden nwr/craft=winery nwr/shop=farm \
